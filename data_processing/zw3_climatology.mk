...
## Phony target
all : ${RWID_DIR}/zw3-dates_Merra_250hPa_daily-anom-wrt-all_${GRID}-hov-env-w${WAVENUMS}-va_${LAT_LABEL}_${CLIP_LABEL}.txt
...
# (generalise the method!!)
${RWID_DIR}/env-w${WAVENUMS}-va_Merra_250hPa_daily-anom-wrt-all_${GRID}.nc : ${PDATA_DIR}/va_Merra_250hPa_daily-anom-wrt-all_{GRID}.nc
	${ENV_METHOD} $< va $@

## Step 4: Calculate the hovmoller diagram
${RWID_DIR}/env-w${WAVENUMS}-va_Merra_250hPa_daily-anom-wrt-all_${GRID}-hov_${LAT_LABEL}_${CLIP_LABEL}.nc : ${RWID_DIR}/env-w${WAVENUMS}-va_Merra_250hPa_daily-anom-wrt-all_${GRID}.nc
	${CDAT} ${DATA_SCRIPT_DIR}/calc_hovmoller.py $< env ${CLIP_METHOD} ${CLIP_THRESH} $@ ${LAT_SEARCH}

## Step 5: Implement the ROIM method
${RWID_DIR}/zw3-roim-stats_Merra_250hPa_daily-anom-wrt-all_${GRID}-hov-env-w${WAVENUMS}-va_${LAT_LABEL}_${CLIP_LABEL}.csv : ${RWID_DIR}/env-w${WAVENUMS}-va_Merra_250hPa_daily-anom-wrt-all_${GRID}-hov_${LAT_LABEL}_${CLIP_LABEL}.nc
...
${RWID_DIR}/zw3-dates_Merra_250hPa_daily-anom-wrt-all_${GRID}-hov-env-w${WAVENUMS}-va_${LAT_LABEL}_${CLIP_LABEL}.txt : ${RWID_DIR}/zw3-roim-stats_Merra_250hPa_daily-anom-wrt-all_${GRID}-hov-env-w${WAVENUMS}-va_${LAT_LABEL}_${CLIP_LABEL}.csv
