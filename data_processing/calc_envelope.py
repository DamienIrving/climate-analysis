...
Description:  Extract the envelope of atmospheric wave packets
...
def main(inargs):
    ...
    data_filtered = uconv.apply_lon_filter(indata.data, inargs.longitude) if inargs.longitude else indata.data
...
"""
    ...
    parser.add_argument("--wavenumbers", type=int, nargs=2, metavar=('LOWER', 'UPPER'), default=[5, 7],
                        help="Wavenumber range [default = (5, 7)]. Upper and lower values are included.")			
