function usage {
    echo "USAGE: bash $0 varfile var contfile contvar date1 date2 outfile"
    ...
    echo "   e.g. bash $0 env_data.nc env zg_data.nc zg 1986-05-22_2006-07-29 plot.png"
    exit 1
}
