...
for region in ${regions[@]}; do
    ...
    for variable in ${variables[@]}; do 
        ...
        if [[ ${group} == 'ensemble' ]] ; then

            if [[ ${variable} == 'so' ]] ; then
                long_name=sea_water_salinity
                obs_ticks="--ticks 2.5 0.5"
    ...
    if [[ ${dry_run} == 'yes' ]] ; then
        echo  ${python} ~/climate-analysis/visualisation/plot_ocean_trend_ensemble.py ${data_files[@]} ${long_name} ${region} ${nrows} ${ncols} ${outfile} --palette ${palette} --climatology_files ${climatology_files[@]} ${ticks[@]} --scale_factor 3 --experiment historical --no_title --runs ${runs[@]}
    else
         ${python} ~/climate-analysis/visualisation/plot_ocean_trend_ensemble.py ${data_files[@]} ${long_name} ${region} ${nrows} ${ncols} ${outfile} --palette ${palette} --climatology_files ${climatology_files[@]} ${ticks[@]} --scale_factor 3 --experiment historical --no_title --runs ${runs[@]}
        echo ${outfile}
    fi
...
for region in ${regions[@]}; do
    ...
    if [[ ${dry_run} == 'yes' ]] ; then
        echo  ${python} ~/climate-analysis/visualisation/plot_ocean_trend_ensemble.py ${data_files[@]} ${long_name} ${region} ${nrows} ${ncols} ${outfile} --palette ${palette} --climatology_files ${climatology_files[@]} ${ticks[@]} --scale_factor 3 --experiment historicalGHG --no_title --runs ${runs[@]}
    else
         ${python} ~/climate-analysis/visualisation/plot_ocean_trend_ensemble.py ${data_files[@]} ${long_name} ${region} ${nrows} ${ncols} ${outfile} --palette ${palette} --climatology_files ${climatology_files[@]} ${ticks[@]} --scale_factor 3 --experiment historicalGHG --no_title --runs ${runs[@]}
        echo ${outfile}
    fi
...
for region in ${regions[@]}; do 
    ...
    if [[ ${dry_run} == 'yes' ]] ; then
        echo  ${python} ~/climate-analysis/visualisation/plot_ocean_trend_ensemble.py ${data_files[@]} ${long_name} ${region} ${nrows} ${ncols} ${outfile} --palette ${palette} --climatology_files ${climatology_files[@]} ${ticks[@]} --scale_factor 3 --experiment historicalAA --no_title --runs ${runs[@]}
    else
         ${python} ~/climate-analysis/visualisation/plot_ocean_trend_ensemble.py ${data_files[@]} ${long_name} ${region} ${nrows} ${ncols} ${outfile} --palette ${palette} --climatology_files ${climatology_files[@]} ${ticks[@]} --scale_factor 3 --experiment historicalAA --no_title --runs ${runs[@]}
        echo ${outfile}
    fi
