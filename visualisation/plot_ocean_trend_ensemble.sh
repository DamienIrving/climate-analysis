...
for region in atlantic pacific indian globe; do
    ...
    for variable in thetao so; do
        ...
        ticks="${canesm_ticks} ${ccsm_ticks} ${fgoals_ticks} ${gfdl_cm_ticks} ${gfdl_esm_ticks} ${gisseh_p1_ticks} ${gisseh_p3_ticks} ${gisser_p1_ticks} ${gisser_p3_ticks} ${ipsl_ticks} ${noresm_ticks}"
        ...
        data_files="${canesm_file} ${ccsm_file} ${fgoals_file} ${gfdl_cm_file} ${gfdl_esm_file} ${gisseh_p1_file} ${gisseh_p3_file} ${gisser_p1_file} ${gisser_p3_file} ${ipsl_file} ${noresm_file}"
        ...
        climatology_files="${canesm_clim} ${ccsm_clim} ${fgoals_clim} ${gfdl_cm_clim} ${gfdl_esm_clim} ${gisseh_p1_clim} ${gisseh_p3_clim} ${gisser_p1_clim} ${gisser_p3_clim} ${ipsl_clim} ${noresm_clim}"
...
for region in atlantic pacific indian globe; do
    ...
    for variable in thetao so; do
        ...
        ticks="${canesm_ticks} ${ccsm_ticks} ${fgoals_ticks} ${gfdl_cm_ticks} ${gfdl_esm_ticks} ${gisseh_ticks} ${gisser_ticks} ${ipsl_ticks} ${noresm_ticks}"
        ...
        data_files="${canesm_file} ${ccsm_file} ${fgoals_file} ${gfdl_cm_file} ${gfdl_esm_file} ${gisseh_file} ${gisser_file} ${ipsl_file} ${noresm_file}"
        ...
        climatology_files="${canesm_clim} ${ccsm_clim} ${fgoals_clim} ${gfdl_cm_clim} ${gfdl_esm_clim} ${gisseh_clim} ${gisser_clim} ${ipsl_clim} ${noresm_clim}"
...
for region in atlantic pacific indian globe; do
    ...
    for variable in thetao so; do
        ...
        data_files="${canesm_file} ${ccsm_file} ${fgoals_file} ${gfdl_cm_file} ${gfdl_esm_file} ${gisseh_p107_file} ${gisseh_p310_file} ${gisser_p107_file} ${gisser_p310_file} ${ipsl_file} ${noresm_file}"
        ...
        climatology_files="${canesm_clim} ${ccsm_clim} ${fgoals_clim} ${gfdl_cm_clim} ${gfdl_esm_clim} ${gisseh_p107_clim} ${gisseh_p310_clim} ${gisser_p107_clim} ${gisser_p310_clim} ${ipsl_clim} ${noresm_clim}"
