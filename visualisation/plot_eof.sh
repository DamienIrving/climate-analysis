...
--infile ${infile} empirical_orthogonal_function3 none none none colour0 3 PlateCarree \
--infile ${infile} empirical_orthogonal_function4 none none none colour0 4 PlateCarree \
--palette RdBu_r \
