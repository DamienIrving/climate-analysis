...
--infile ${varfile} ${var}_annual none none none colour0 1 \
--infile ${varfile} ${var}_DJF none none none colour0 3 \
--infile ${varfile} ${var}_MAM none none none colour0 4 \
--infile ${varfile} ${var}_JJA none none none colour0 5 \
--infile ${varfile} ${var}_SON none none none colour0 6 \
--palette ${palette} \
--colourbar_ticks ${ticks} \
--output_projection SouthPolarStereo \
--subplot_headings Annual none DJF MAM JJA SON \
--infile ${contfile} ${contvar}_annual none none none contour0 1 \
--infile ${contfile} ${contvar}_DJF none none none contour0 3 \
--infile ${contfile} ${contvar}_MAM none none none contour0 4 \
--infile ${contfile} ${contvar}_JJA none none none contour0 5 \
--infile ${contfile} ${contvar}_SON none none none contour0 6 \
